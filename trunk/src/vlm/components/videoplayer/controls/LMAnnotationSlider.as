...
{
import com.fxcomponents.controls.fxslider.LMLeftBracket;
import com.fxcomponents.controls.fxslider.LMRightBracket;
import vlm.components.videoplayer.controls.fxslider.LMSliderThumb;
import vlm.skins.videoplayer.SliderThumbSkin;
import vlm.skins.videoplayer.SliderTrackSkin;
...
public class LMAnnotationSlider extends UIComponent
{
	
	public function LMAnnotationSlider()
	{
		super();
	}
	...
	protected var thumb:LMSliderThumb;
	protected var leftBracket:LMLeftBracket;
	protected var rightBracket:LMRightBracket;
	...
	override protected function createChildren():void
	{
        ...
        if(!thumbSkin)
        	thumbSkin = vlm.skins.videoplayer.SliderThumbSkin;
		
		trackSkin = getStyle("trackSkin");
        if(!trackSkin)
        	trackSkin = vlm.skins.videoplayer.SliderTrackSkin;
		
		trackHighlightSkin = getStyle("trackHighlightSkin");
        if(!trackHighlightSkin)
        	trackHighlightSkin = vlm.skins.videoplayer.SliderHighlightSkin;
		...
		thumb = new LMSliderThumb();
		addChild(thumb);
		
		leftBracket = new LMLeftBracket();
		addChild(leftBracket);
		
		leftBracket.addEventListener(MouseEvent.MOUSE_DOWN, onMouseOnLeftBracket);
		
		rightBracket = new LMRightBracket();
	...
	override protected function commitProperties():void
	{
        ...
        rightBracket.x = this.width - rightBracket.width
	}
	...
	private function onMouseOnLeftBracket(event:MouseEvent):void
	{
		leftBracket.startDrag;
		var h:HSlider
